<!-- Loading.vue -->
<template>
  <div class="w-100vw h-100vh flex-center flex-col bg-[#F7FAFC] fixed top-0 left-0 z-999">
    <div id="wifi-loader">
      ...
      <div :data-text="text" class="text"></div>
    </div>
    <!-- <div class="m-t-20px">{{ text }}</div> -->
  </div>
</template>
...
const theme = computed(() => useTheme.primaryColor)
